                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="tpl-table-black-operation">\
                                                    <c:if test="${item.status!=3}">
                                                        <a href="<%=basePath%>/goods_opGoods?id=${item.id}&status=${item.status}">
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        <li class="am-disabled"><a
                                                href="<%=basePath%>goods_goodsList?page=${page-1}&rows=10">«</a></li>
                                        <c:forEach varStatus="i" begin="1"
                                                   end="${goodsGrid.totalPage}">
                                            <li class="${page==i.count?'am-active':""}"><a
                                                    href="<%=basePath%>goods_goodsList?page=${i.count}&rows=10">${i.count}</a>
                                            </li>
                                        </c:forEach>
                                        <li><a href="<%=basePath%>goods_goodsList?page=${page+1}&rows=10">»</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
