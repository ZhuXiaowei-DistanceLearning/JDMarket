...
<%
    /* *
     * 功能：支付宝手机网站支付接口(com.alipay.trade.wap.pay)接口调试入口页面
     * 版本：2.0
     * 修改日期：2016-11-01
     * 说明：
...
%>
<c:set var="money" value="<%=money%>"></c:set>
<!DOCTYPE html>
<html>
<head>
...
<header class="am-header">
    <h1>支付宝手机网站支付接口快速通道(接口名：com.alipay.trade.wap.pay)</h1>
</header>
<div id="main">
...
<script language="javascript">
    function GetDateNow() {
        ...
        document.getElementById("WIDbody").value = "账户余额充值";
    }
    GetDateNow();
</script>
</html>